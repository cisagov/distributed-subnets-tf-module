...
issue](https://github.com/cisagov/shared-services-vpc-tf-module/issues) in this
...
request](https://github.com/cisagov/shared-services-vpc-tf-module/pulls), you
...
```console
cd shared-services-vpc-tf-module
pyenv virtualenv <python_version_to_use> shared-services-vpc-tf-module
pyenv local shared-services-vpc-tf-module
